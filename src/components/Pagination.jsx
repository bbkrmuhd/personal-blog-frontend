...
<nav aria-label="Page Navigation">
  <ul className="inline-flex -space-x-px">
    ...
    <li>
      <a href="#" aria-current="page" className="py-2 px-3 text-cyan-700 bg-blue-50 border border-gray-300 hover:bg-cyan-100 hover:text-cyan-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">3</a>
    </li>
    <li>
