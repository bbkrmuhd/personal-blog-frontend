...
const NavBar = () => {
  ...
  return (
    <div className='container mx-auto border-b px-4 dark:border-b-gray-700'>
        ...
        <div className='flex items-center space-x-4 bg-gray-50 w-full sm:w-auto dark:bg-gray-800 sm:dark:bg-gray-900 rounded-lg border sm:border-0 sm:bg-white justify-between sm:justify-start dark:border-gray-700'>
