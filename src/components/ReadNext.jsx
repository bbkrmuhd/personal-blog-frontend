  ...
  return (
      <div className='flex sm:flex-col rounded-md shadow-sm shadow-gray-300'>
          ...
          <div className='flex flex-col gap-2 mb-2 sm:mt-2 px-2 w-full'>
            ...
            <Link to={`/post/detail/${slug}`}><p className='font-bold text-left text-sm sm:text-base text-slate-900 hover:text-cyan-700 capitalize cursor-pointer truncate-line-clamp'>
                {title}
                </p>
              </Link>
