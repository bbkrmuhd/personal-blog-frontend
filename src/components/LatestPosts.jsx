...
const LatestPosts = ({ post }) => {
  ...
  return (
    <div className='max-h-32 my-4 shadow-sm'>
      <div className='flex flex-col flex-none gap-6 rounded-lg bg-stone-100 '>
        <div className='flex gap-2'>
            ...
            <div className='flex-auto p-2'>
                ...
                <div className='flex items-center gap-1 text-gray-500 text-[10px]'>
                        <img className='w-8' src="https://avatars.githubusercontent.com/u/68012668?v=4" alt="" />
                        <p>by <span className='font-bold text-gray-900'>Ameer</span></p>-
                        <p>5 min read</p>
                 </div>
                 <div>
                    <h2 className='font-bold text-justify text-sm  text-black'>Lorem ipsum, dolor sit amet consectetur adipisicing elit....</h2>
                </div>
