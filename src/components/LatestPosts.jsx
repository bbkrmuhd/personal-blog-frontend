  ...
  return (
    <div className='flex flex-col min-h-32 gap-6 bg-gray-50 rounded-lg shadow-sm shadow-gray-200 my-4 max-w-70 dark:bg-gray-800 dark:shadow-gray-700' >
        <div className='flex gap-2'>
            ...
            <Link to={`/posts/detail/${post.slug}`}> <img height='100%' width='100%' className='inset-0 h-full w-full absolute object-cover border-none rounded-l-lg transition-all hover:scale-105' src={post?.image} alt="photo" loading='lazy' /></Link>
            </div>
                <div className='flex flex-col h-full gap-2 justify-between p-2'>
                  ...
                  <Link to="/about">  <img width='32px' className='transform hover:scale-105 border-none rounded-full' src="https://avatars.githubusercontent.com/u/68012668?v=4" alt="avatar" /></Link>
